...
import '../css/Calculator.css.scss';
  ...
  render() {
    ...
    return (
      <div className="App calculator">
        <div className="row justify-content-center zero-margin">
              ...
              <div className="row">
                ...
                <div className="col-md-12 calculator-body-part">
                  <div className="row justify-content-center">
                    <CalculatorButton isIcon={ 'fa fa-undo' } buttonClass="btn btn-primary top-button"
                                      onClick={ this.undoClick }/>
                    <CalculatorButton buttonClass="btn btn-primary top-button" isIcon={ 'fa fa-arrow-left' }
                                      onClick={ () => this.functionalButtonClick("CUT_FIRST") }/>
                    <CalculatorButton buttonClass="btn btn-primary top-button  text-bold"
                                      onClick={ () => this.functionalButtonClick("C") } textValue="C"/>
                    <CalculatorButton buttonClass="btn btn-primary top-button  text-bold"
                                      onClick={ () => this.functionalButtonClick("AC") } textValue="AC"/>

                  </div>

                  <div className="row justify-content-center mt-2">
                    <CalculatorButton buttonClass="btn btn-success btn-mem text-bold"
                                      onClick={ () => this.functionalButtonClick('MC') } textValue="mc"/>
                    <CalculatorButton buttonClass="btn btn-success btn-mem text-bold"
                                      onClick={ () => this.functionalButtonClick('M+') } textValue="m+"/>
                    <CalculatorButton buttonClass="btn btn-success btn-mem text-bold"
                                      onClick={ () => this.functionalButtonClick('M-') } textValue="m-"/>
                    <CalculatorButton buttonClass="btn btn-success btn-mem text-bold"
                                      onClick={ () => this.functionalButtonClick('MR') } textValue="mr"/>
                  </div>


                  <div className="row justify-content-center mt-2">
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(7) } textValue="7"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(8) } textValue="8"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(9) } textValue="9"/>
                    ...
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                                      textValue="√" onClick={ () => this.functionalButtonClick("SQ_ROOT") }/>
                  </div>

                  <div className="row justify-content-center mt-2">
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(4) } textValue="4"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(5) } textValue="5"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                  ...
                  <div className="row justify-content-center mt-2">
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(1) } textValue="1"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(2) } textValue="2"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                  ...
                  <div className="row justify-content-center mt-2">
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-digit text-bold"
                                      onClick={ () => this.digitClick(0) } textValue="0"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                                      onClick={ () => this.dotClick() } textValue="."/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                                      onClick={ () => this.functionalButtonClick('+-') } textValue="±"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-operation text-bold"
                                      onClick={ () => this.operationClick('+') } textValue="+"/>
                    <CalculatorButton buttonClass="btn btn-primary btn-digit-operation btn-equal text-bold"
                                      onClick={ () => this.equalClick() } textValue="="/>
                  </div>
