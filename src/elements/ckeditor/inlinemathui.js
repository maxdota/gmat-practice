...
export default class InlineMathUI extends Plugin {
  init() {
    ...
    editor.ui.componentFactory.add('inlineMath', locale => {
      ...
      const command = editor.commands.get('inlineMath');
      dropdownView.bind('isEnabled').to(command);

      // Execute the command when the dropdown item is clicked (executed).
      this.listenTo(dropdownView, 'execute', evt => {
        editor.execute('inlineMath', {
          value: {
